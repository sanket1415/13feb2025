...
const StudentLogin = ({ setCurrentPage, handleInputChange, handleLogin, formData }) => {
  return (
    <div className="login-page card mx-auto my-5" style={{ maxWidth: '400px' }}>
      <div className="card-body">
        ...
        <p className="text-center mt-3">Don't have an account? 
          <button className="btn btn-link" onClick={() => setCurrentPage("studentSignUp")}>Student Sign Up</button>
        </p>
